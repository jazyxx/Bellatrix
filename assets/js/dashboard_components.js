...
async function injectDashboardLayout(rol, activeTabId) {
  const sidebarLinks = {
    'Cliente': [
      { id: 'cliente_pedidos', href: 'cliente_dashboard.html', text: '📦 Mis Pedidos' },
      { id: 'logout', href: '#', text: '🚪 Cerrar Sesión', onclick: 'cerrarSesionDashboard()' }
    ],
    'Administrador': [
      { id: 'admin_pos', href: 'admin_pos.html', text: '🛒 Punto de Venta' },
      { id: 'admin_caja', href: 'admin_caja.html', text: '💵 Control de Caja' },
      { id: 'admin_inventario', href: 'admin_inventario.html', text: '🍰 Inventario/Recetas' },
      { id: 'admin_pedidos', href: 'admin_pedidos.html', text: '🚚 Pedidos Online' },
      { id: 'admin_ventas', href: 'admin_ventas.html', text: '📈 Historial Ventas' },
      { id: 'logout', href: '#', text: '🚪 Salir', onclick: 'cerrarSesionDashboard()' }
    ],
    'Cajero': [
      { id: 'cajero_pos', href: 'admin_pos.html', text: '🛒 Punto de Venta' },
      { id: 'cajero_inventario', href: 'admin_inventario.html', text: '🍰 Inventario' },
      { id: 'cajero_pedidos', href: 'admin_pedidos.html', text: '🚚 Pedidos Online' },
      { id: 'cajero_ventas', href: 'admin_ventas.html', text: '📈 Mis Ventas' },
      { id: 'logout', href: '#', text: '🚪 Salir', onclick: 'cerrarSesionDashboard()' }
    ]
  };
